...
- Open `/legacy` for a compact, text-first timeline with a 100-item default limit; it omits per-item comments and original links, and its bottom unlock lasts only until leaving minimal mode
